...
(function() {
  define('cs!timeline/components/Utils',['require'],function(require) {
    var Utils;
...
(function() {
  ...
  define('cs!timeline/components/Header',['require','jquery','d3','Signal','cs!timeline/components/Utils'],function(require) {
    ...
    return Header = (function() {
      function Header(app, timer, initialDomain, width) {
        this.app = app;
        this.timer = timer;
...
(function() {
  ...
  define('cs!timeline/components/TimeIndicator',['require','jquery','d3','Signal'],function(require) {
...
(function() {
  ...
  define('cs!timeline/components/Items',['require','d3','Signal'],function(require) {
    var Items, Signals, d3;
    d3 = require('d3');
    Signals = require('Signal');
    return Items = (function() {
      ...
      Items.prototype.render = function() {
        ...
        barEnter.append("text").attr("class", "line--label").attr("x", self.timeline.label_position_x + 10).attr("y", 16).text(function(d) {
          ...
          return self.onSelect.dispatch(d);
        });
        self = this;
...
(function() {
  define('cs!timeline/components/Properties',['require','d3','Signal'],function(require) {
    var Properties, Signals, d3;
    d3 = require('d3');
    Signals = require('Signal');
...
(function() {
  define('cs!timeline/components/Keys',['require','d3','Signal'],function(require) {
    var Keys, Signals, d3;
    d3 = require('d3');
    Signals = require('Signal');
...
(function() {
  ...
  define('cs!timeline/Timeline',['require','jquery','d3','Signal','cs!timeline/components/Utils','cs!timeline/components/Header','cs!timeline/components/TimeIndicator','cs!timeline/components/Items','cs!timeline/components/Properties','cs!timeline/components/Keys'],function(require) {
    var $, Header, Items, Keys, Properties, Signals, TimeIndicator, Timeline, Utils, d3, extend;
    $ = require('jquery');
    d3 = require('d3');
    Signals = require('Signal');
    Utils = require('cs!timeline/components/Utils');
    ...
    return Timeline = (function() {
      function Timeline() {
        ...
        this.items.onSelect.add((function(_this) {
          return function(d) {
...
(function() {
  define('cs!timeline/components/PropertyNumber',['require','jquery','Mustache','text!app/templates/propertyNumber.tpl.html'],function(require) {
    ...
    return PropertyIndicator = (function() {
      function PropertyIndicator(attr) {
        var data, view;
        this.attr = attr;
...
(function() {
  ...
  define('cs!timeline/components/PropertiesEditor',['require','jquery','cs!timeline/components/PropertyNumber','text!app/templates/propertiesEditor.tpl.html'],function(require) {
    var $, PropertiesEditor, PropertyNumber, tpl_propertiesEditor;
    $ = require('jquery');
    ...
    return PropertiesEditor = (function() {
      ...
      PropertiesEditor.prototype.onSelect = function(selectedObject) {
        ...
        return this.$container.append(prop.$el);
      };
...
//# sourceMappingURL=boot-editor.js.map