...
define('text!modules/templates/timeline.tpl.html',[],function () { return '<div class="editor__time">\n  <div class="editor__time-header">\n    <div class="editor__time--left editor__time-controls">\n\n    </div>\n  </div>\n  <div class="editor__time-main">\n\n  </div>\n</div>\n';});


(function() {
  define('cs!modules/Editor',['require','jquery','d3','text!modules/templates/timeline.tpl.html'],function(require) {
    var $, Editor, d3, tpl_timeline;
    $ = require('jquery');
    d3 = require('d3');
