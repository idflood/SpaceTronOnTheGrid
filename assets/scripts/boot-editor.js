...
(function() {
  ...
  define('cs!timeline/components/Items',['require','d3','Signal','lodash'],function(require) {
    var Items, Signals, d3, _;
    d3 = require('d3');
    Signals = require('Signal');
    _ = require('lodash');
...
(function() {
  ...
  define('cs!timeline/components/PropertyNumber',['require','jquery','Signal','Mustache','text!app/templates/propertyNumber.tpl.html'],function(require) {
    ...
    return PropertyIndicator = (function() {
      function PropertyIndicator(property, instance_property, object, timer) {
